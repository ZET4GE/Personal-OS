  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="h-9 w-24 animate-pulse rounded-lg bg-surface-3" />
      </div>

      {/* group skeleton */}
      {['Hoy', 'Esta semana'].map((label) => (
        <section key={label}>
          <div className="mb-2 h-3 w-16 animate-pulse rounded bg-surface-3" />
            ...
            {[...Array(3)].map((_, i) => (
              <div key={i} className="flex gap-3 rounded-lg px-3 py-3">
                ...
                <div className="flex-1 space-y-2">
                  ...
                  <div className="h-2 w-1/4 animate-pulse rounded bg-surface-3" />
                </div>
              </div>
            ))}
          </div>
