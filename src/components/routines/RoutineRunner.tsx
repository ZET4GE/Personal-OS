      ...
      {!isFinished && (
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 rounded-xl border border-border bg-surface-2 px-3 py-2 text-sm text-text outline-none transition-colors focus:border-accent-600 disabled:opacity-50"
          />
          <button
            type="button"
