          ...
          {goals.map((goal) => {
            ...
            return (
              <Link
                key={goal.id}
                href={`/goals/${goal.id}`}
                className="min-w-[260px] flex-1 rounded-xl border border-border bg-surface-elevated p-4 transition-colors hover:border-border-bright hover:bg-surface-hover"
              >
